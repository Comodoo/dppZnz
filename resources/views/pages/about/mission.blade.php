...
<head>
    ...
    <title>Vission and Misson - Dpp znz</title>
    <style>
...
<body>
    ...
    <div class="hero-banner">
        ...
        <div class="hero-content">
            <h1 class="hero-title" style="color: white;">Vission, Mission & Motto</h1>
            <p class="hero-subtitle">Vission, Mission and Motto</p>
        </div>
    ...
    <div class="container">
        <div class="main-card">
            ...
            <!-- About Us Text (First) -->
            <div class="section-title">VISSION, MISSION & MOTTO</div>
            ...
            <div class="vision-mission-motto">
                ...
                <div class="card">
                    <div class="card-content">
                        ...
                        <p class="card-desc">To provide independent, impartial, and effective prosecution services in
                            Zanzibar, ensuring justice is served for all.</p>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-content">
                        ...
                        <p class="card-desc">To be a professional, accountable, and trusted prosecution authority that
                            upholds the rule of law and promotes public confidence.</p>
                    </div>
                </div>
                    ...
                    <div class="card-content">
                        <div class="card-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M7 8h10M7 12h10m-4 8h4a2 2 0 002-2V7l-5-5H7a2 2 0 00-2 2v16a2 2 0 002 2z" />
                            </svg>
                        </div>
            ...
            <p>The DPP Zanzibar has six core values that guide and direct the behavior of its officers at all levels.
                These values reflect the culture of the Office, ensuring that all officers conduct prosecutions with
                integrity,
            ...
            <div class="values-grid">
                ...
                <div class="card">
                    <div class="card-content">
                        ...
                        <p class="card-desc">Personal character of officers working in the DPP's Office during and
                            after office hours should reflect the judicious nature of the prosecution office.</p>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-content">
                        ...
                        <p class="card-desc">Prosecution is not a vengeful mission; it is a mission to present the
                            truth before the court of law as known by the witnesses.</p>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-content">
                        ...
                        <p class="card-desc">The 1984 Zanzibar Constitution guarantees independence of the prosecution
                            authority. It is the duty of the prosecutors to uphold the independence by being honest.</p>
                    </div>
                </div>
                    ...
                    <div class="card-content">
                        <div class="card-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M9 12l2 2 4-4m2 6l4-4m-6-2l2 2" />
                            </svg>
                        </div>
                        <h3 class="card-title">Fairness</h3>
                        <p class="card-desc">Prosecution should never be turned into persecution. It should never be
                            used to achieve any other end except the end of justice.</p>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-content">
                        ...
                        <p class="card-desc">Being timely, cooperative and pursuing each prosecution with necessary
                            zeal to meet the end of justice.</p>
                    </div>
                </div>
                        ...
                        <div class="card-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                ...
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M12 6v6l4 2" />
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M20.39 10.37a8 8 0 11-16.78 0 8 8 0 0116.78 0z" />
                            </svg>
                        </div>
