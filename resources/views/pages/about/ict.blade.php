...
<head>
    ...
    <title>Kitengo cha TEHAMA - DPP Zanzibar</title>
    <style>
...
<body>
    ...
    <div class="hero-banner">
        <div class="digital-pattern">
            <!-- SVG Pattern with technology icons -->
            <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 1200 300">
                ...
                <!-- Technology Icons (Computer/Tech themed) -->
                <g opacity="0.4">
                    <path
        ...
        <div class="hero-content">
            <h1 class="hero-title">KITENGO CHA TEHAMA</h1>
            <p class="hero-subtitle">Teknolojia ya Habari na Mawasiliano - Kuimarisha Mfumo wa Dijitali katika Afisi ya DPP</p>
        </div>
    </div>
        ...
        <div class="main-card">
            <div class="content-wrapper">
                ...
                <div class="page-header">
                    <h1>Kitengo cha TEHAMA (Teknolojia ya Habari na Mawasiliano)</h1>
                    <p class="intro-text">
                        Kitengo hiki kinahusika na kutoa msaada wa Teknolojia habari na mawasiliano katika Afisi na 
                        kutoa huduma ya uhusiano baina ya Afisi na mashirika mengine. Kinahakikisha mfumo wa kidijitali 
                        unaendeshwa kwa ufanisi na usalama.
                    </p>
                </div>
                ...
                <div class="mandate-section">
                    ...
                    <p>
                        Kitengo cha TEHAMA (Teknolojia ya Habari na Mawasiliano) kina jukumu muhimu la kuhakikisha 
                        kuwa mifumo ya kidijitali, mawasiliano na teknolojia ya habari katika Afisi ya DPP Zanzibar 
                        inafanya kazi kwa ufanisi na usalama. Kitengo hiki kinasimamia mifumo mikuu ya kompyuta, 
                        mitandao ya mawasiliano, na teknolojia mbalimbali zinazosaidia utendaji wa Afisi.
                    </p>
                    <p>
                        Lengo kuu la kitengo hiki ni kuhakikisha kuwa Afisi ina mifumo ya kisasa ya teknolojia na 
                        mawasiliano ambayo inasaidia utekelezaji bora wa majukumu yake, huku kikiwa na usalama kamili 
                        wa taarifa na mawasiliano.
                    </p>
                </div>
                    ...
                    <div class="focus-grid">
                        ...
                        <div class="focus-card">
                            <div class="focus-card-header">
                                ...
                                <div class="focus-title">Teknolojia ya Habari</div>
                            </div>
                            <div class="focus-content">
                                <p class="focus-description">
                                    Kusimamia na kuendeleza mifumo ya kompyuta, program, na teknolojia za habari 
                                    zinazotumika katika Afisi kwa ajili ya utendaji bora wa kazi.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="focus-card">
                            <div class="focus-card-header">
                                <div class="focus-icon">📡</div>
                                <div class="focus-title">Mawasiliano na Mtandao</div>
                            </div>
                            <div class="focus-content">
                                <p class="focus-description">
                                    Kuhakikisha mifumo ya mawasiliano, mitandao ya ndani na nje, na uhusiano baina 
                                    ya Afisi na mashirika mengine yanafanya kazi kwa ufanisi.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="focus-card">
                            <div class="focus-card-header">
                                <div class="focus-icon">🔒</div>
                                <div class="focus-title">Usalama wa Taarifa</div>
                            </div>
                            <div class="focus-content">
                                <p class="focus-description">
                                    Kuhakikisha usalama wa taarifa, programu, na mifumo ya teknolojia, pamoja na 
                                    uhifadhi salama wa kumbukumbu za kidijitali.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="functions-list">
                        ...
                        <div class="function-item">
                            ...
                            <div class="function-content">
                                <div class="function-title">Kuratibu Uanzishwaji na Utekelezaji wa Mkakati wa Mawasiliano</div>
                        ...
                        <div class="function-item">
                            ...
                            <div class="function-content">
                                <div class="function-title">Kushauri Uongozi juu ya Matumizi ya Teknolojia</div>
                                <p class="function-description">
                        ...
                        <div class="function-item">
                            ...
                            <div class="function-content">
                                <div class="function-title">Kuhakikisha Mipango ya Teknolojia</div>
                                <p class="function-description">
                                    Kuhakikisha kwamba, mipango ya uanzishwaji na uendelezaji wa teknolojia ya 
                                    mawasiliano ipo katika hali nzuri na hauna gharama.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="function-item">
                            ...
                            <div class="function-content">
                                <div class="function-title">Kusimamia Muundo na Sheria za Teknolojia</div>
                                <p class="function-description">
                                    Kusimamia muundo na mpangilio, sheria na taratibu katika kuendeleza na kutumia 
                                    mfumo wa habari.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="function-item">
                            ...
                            <div class="function-content">
                                <div class="function-title">Kuratibu Uhifadhi wa Program</div>
                                <p class="function-description">
                        ...
                        <div class="function-item">
                            ...
                            <div class="function-content">
                                <div class="function-title">Kutunza Kumbukumbu za Matumizi ya Kompyuta</div>
                                <p class="function-description">
                        ...
                        <div class="function-item">
                            ...
                            <div class="function-content">
                                <div class="function-title">Kufanya Kazi Nyingine Zilizopangiwa</div>
                                <p class="function-description">
                ...
                <div class="important-note">
                    <h3>Umuhimu wa Kitengo cha TEHAMA</h3>
                    <p>
                        Kitengo cha TEHAMA kina jukumu muhimu katika kuhakikisha uendeshaji bora wa mifumo ya kidijitali 
                        na mawasiliano katika Afisi ya DPP. Katika eneo la kisasa la teknolojia, mifumo ya habari na 
                        mawasiliano ni kiini cha utendaji wa taasisi yoyote. Kitengo hiki kinahakikisha kuwa Afisi ina 
                        mifumo ya kisasa, salama na yenye ufanisi ambayo inasaidia utendaji wa kila siku. Zaidi ya haye, 
                        kinachangia kwa kiasi kikubwa katika uhifadhi wa siri za kitaasisi na usalama wa taarifa muhimu. 
                        Katika ulimwengu wa sasa unaotegemea teknolojia, kitengo cha TEHAMA ni muhimu kwa ajili ya 
                        kuhakikisha ufanisi, usalama na uendelevu wa shughuli za Afisi.
                    </p>
                </div>
            </div>
        </div>
