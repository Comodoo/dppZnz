...
<head>
    ...
    <title>Divisheni ya Utunzaji wa Kumbukumbu na Nyaraka - DPP Zanzibar</title>
    <style>
...
<body>
    ...
    <div class="hero-banner">
        ...
        <div class="hero-content">
            <h1 class="hero-title">DIVISHENI YA UTUNZAJI WA KUMBUKUMBU NA NYARAKA</h1>
            <p class="hero-subtitle">Usimamizi Bora wa Kumbukumbu, Uhifadhi na Usalama wa Nyaraka za Taasisi</p>
        </div>
    </div>
        ...
        <div class="main-card">
            <div class="content-wrapper">
                ...
                <div class="page-header">
                    <h1>Divisheni ya Utunzaji wa Kumbukumbu na Nyaraka</h1>
                    <p class="intro-text">
                        Divisheni hii ina jukumu la kusimamia masuala na kuweka mfumo bora wa uhifadhi na 
                        utunzaji kumbukumbu, kuhakikisha usalama na urahisi wa upatikanaji wa nyaraka muhimu 
                        za taasisi kwa ajili ya utendaji bora na maamuzi sahihi.
                    </p>
                </div>
                ...
                <div class="mandate-section">
                    ...
                    <p>
                        Divisheni ya Utunzaji wa Kumbukumbu na Nyaraka ina jukumu muhimu la kusimamia mfumo 
                        wa uhifadhi na utunzaji wa kumbukumbu za taasisi. Divisheni hii inalenga kuhakikisha 
                        kwamba kumbukumbu zote muhimu za taasisi zinahifadhiwa kwa usalama, zinatunzwa kwa utaratibu, 
                        na zinapatikana kwa urahisi na kwa wakati kila zinapohitajika.
                    </p>
                    <p>
                        Lengo kuu la divisheni hii ni kuweka mfumo bora wa usimamizi wa kumbukumbu, kulinda 
                        usiri wa nyaraka muhimu, na kuhakikisha upatikanaji wa haraka na sahihi wa taarifa 
                        muhimu kwa ajili ya utendaji wa taasisi na utoaji wa maamuzi.
                    </p>
                </div>
                    ...
                    <div class="focus-grid">
                        ...
                        <div class="focus-card">
                            <div class="focus-card-header">
                                ...
                                <div class="focus-title">Uhifadhi na Usimamiji wa Kumbukumbu</div>
                            </div>
                            <div class="focus-content">
                                <p class="focus-description">
                                    Uwekezaji wa mifumo bora ya uhifadhi, kupanga na kupangilia kumbukumbu katika 
                                    makundi na kuweka katika makabati na rafu kwa utaratibu.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="focus-card">
                            <div class="focus-card-header">
                                ...
                                <div class="focus-title">Usalama na Udhibiti wa Nyaraka</div>
                            </div>
                            <div class="focus-content">
                                <p class="focus-description">
                                    Kuhakikisha usalama na usiri wa kumbukumbu muhimu, kudhibiti upokeaji na utoaji 
                                    wa nyaraka, na kulinda data muhimu dhidi ya uharibifu au upotevu.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="focus-card">
                            <div class="focus-card-header">
                                <div class="focus-icon">📋</div>
                                <div class="focus-title">Upatikanaji na Usambazaji wa Taarifa</div>
                            </div>
                            <div class="focus-content">
                                <p class="focus-description">
                                    Kutoa huduma za kutumia na kusambaza kumbukumbu kwa watendaji, kuandaa ripoti, 
                                    na kuhakikisha kuwa taarifa zinapatikana kwa wakati na kwa urahisi.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="functions-list">
                        ...
                        <div class="function-item">
                            ...
                            <div class="function-content">
                                <div class="function-title">Usimamiji wa Mfumo wa Uhifadhi</div>
                        ...
                        <div class="function-item">
                            ...
                            <div class="function-content">
                                <div class="function-title">Kuhakikisha Usalama na Usiri</div>
                                <p class="function-description">
                        ...
                        <div class="function-item">
                            ...
                            <div class="function-content">
                                <div class="function-title">Utunzaji na Upatikanaji wa Kumbukumbu</div>
                                <p class="function-description">
                        ...
                        <div class="function-item">
                            ...
                            <div class="function-content">
                                <div class="function-title">Udhibiti wa Upokeaji na Utoaji</div>
                                <p class="function-description">
                        ...
                        <div class="function-item">
                            ...
                            <div class="function-content">
                                <div class="function-title">Upokeaji na Utoaji wa Barua na Kumbukumbu</div>
                                <p class="function-description">
                        ...
                        <div class="function-item">
                            ...
                            <div class="function-content">
                                <div class="function-title">Uchambuzi na Upangaji wa Kumbukumbu</div>
                                <p class="function-description">
                        ...
                        <div class="function-item">
                            ...
                            <div class="function-content">
                                <div class="function-title">Uwekaji na Upangaji katika Chumba cha Masjala</div>
                                <p class="function-description">
                        ...
                        <div class="function-item">
                            ...
                            <div class="function-content">
                                <div class="function-title">Huduma za Kutumia na Kusambaza Kumbukumbu</div>
                                <p class="function-description">
                        ...
                        <div class="function-item">
                            ...
                            <div class="function-content">
                                <div class="function-title">Uandaji na Uwasilishaji wa Ripoti</div>
                                <p class="function-description">
                ...
                <div class="important-note">
                    <h3>Umuhimu wa Usimamizi Bora wa Kumbukumbu</h3>
                    <p>
                        Divisheni ya Utunzaji wa Kumbukumbu na Nyaraka ina jukumu muhimu katika kuhakikisha 
                        utendaji bora wa taasisi. Kumbukumbu zilizosimamiwa vizuri ni msingi wa maamuzi sahihi, 
                        utendaji wa kisheria, na ufuatiliaji wa mafanikio ya taasisi. Usimamizi bora wa kumbukumbu 
                        husaidia kuokoa muda, kuzuia upotevu wa taarifa muhimu, na kuhakikisha kuwa taarifa zote 
                        zinapatikana kwa wakati na kwa usahihi. Hii ni muhimu hasa katika taasisi ya kisheria kama 
                        Ofisi ya DPP ambapo usahihi, usiri na upatikanaji wa kumbukumbu ni muhimu kwa utendaji 
                        wa haki na uadilifu.
                    </p>
                </div>
            </div>
