...
<head>
    ...
    <title>Divisheni ya Mipango na Takwimu - DPP Zanzibar</title>
    <style>
...
<body>
    ...
    <div class="hero-banner">
        ...
        <div class="hero-content">
            <h1 class="hero-title">DIVISHENI YA MIPANGO NA TAKWIMU</h1>
            <p class="hero-subtitle">Usimamizi wa Mipango, Upangaji wa Bajeti na Uchambuzi wa Takwimu</p>
        </div>
    </div>
        ...
        <div class="main-card">
            <div class="content-wrapper">
                ...
                <div class="page-header">
                    <h1>Divisheni ya Mipango na Takwimu</h1>
                    <p class="intro-text">
                        Divisheni hii ina jukumu la kusimamia mipango na takwimu za Ofisi, kuhakikisha upangaji 
                        bora wa rasilimali, uchambuzi wa data, na utoaji wa taarifa za kitaalamu kwa madhumuni 
                ...
                <div class="mandate-section">
                    ...
                    <p>
                        Divisheni ya Mipango na Takwimu ina jukumu muhimu la kusimamia mipango na takwimu za 
                        Ofisi ya DPP Zanzibar. Divisheni hii inalenga kuhakikisha kwamba shughuli zote za 
                        taasisi zinaendeshwa kwa mujibu wa mipango iliyokusudiwa, bajeti inatumiwa kwa ufanisi, 
                        na takwimu zinazotolewa ni sahihi na zinatumika kwa kutengeneza maamuzi ya kiuchumi.
                    </p>
                    <p>
                        Lengo kuu la divisheni hii ni kutoa mwongozo wa kimaendeleo, kufanya uchambuzi wa takwimu 
                        wa kitaalamu, na kuhakikisha utoaji wa taarifa sahihi kwa ajili ya uongozi na maamuzi ya 
                        kitaasisi.
                    </p>
                </div>
                    ...
                    <div class="focus-grid">
                        ...
                        <div class="focus-card">
                            <div class="focus-card-header">
                                ...
                                <div class="focus-title">Usimamiji wa Mipango</div>
                            </div>
                            <div class="focus-content">
                                <p class="focus-description">
                                    Uandaji, kuratibu na ufuatiliaji wa mipango ya kazi, mikakati ya muda wa kati, 
                                    na bajeti za taasisi kwa kipindi cha mwaka.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="focus-card">
                            <div class="focus-card-header">
                                <div class="focus-icon">💰</div>
                                <div class="focus-title">Upangaji wa Bajeti</div>
                            </div>
                            <div class="focus-content">
                                <p class="focus-description">
                                    Uratibu wa utayarishaji, utekelezaji na ufuatiliaji wa bajeti ya Afisi, 
                                    kuhakikisha matumizi bora ya fedha kwa mujibu wa mipango ya kazi.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="focus-card">
                            <div class="focus-card-header">
                                <div class="focus-icon">📈</div>
                                <div class="focus-title">Uchambuzi wa Takwimu</div>
                            </div>
                            <div class="focus-content">
                                <p class="focus-description">
                                    Ukusanyaji, uchambuzi na utafsiri wa takwimu na taarifa za kiuchumi kwa 
                                    ajili ya utoaji wa maamuzi ya kitaalamu na taarifa za kitaasisi.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="functions-list">
                        ...
                        <div class="function-item">
                            ...
                            <div class="function-content">
                                <div class="function-title">Ukusanyaji na Uandaji wa Taarifa za Mipango</div>
                        ...
                        <div class="function-item">
                            ...
                            <div class="function-content">
                                <div class="function-title">Uratibu wa Bajeti</div>
                                <p class="function-description">
                        ...
                        <div class="function-item">
                            ...
                            <div class="function-content">
                                <div class="function-title">Ukusanyaji wa Taarifa za Miradi na Mipango Kazi</div>
                                <p class="function-description">
                        ...
                        <div class="function-item">
                            ...
                            <div class="function-content">
                                <div class="function-title">Ushauri wa Kitaalamu</div>
                                <p class="function-description">
                        ...
                        <div class="function-item">
                            ...
                            <div class="function-content">
                                <div class="function-title">Ukusanyaji wa Taarifa za Mapitio</div>
                                <p class="function-description">
                        ...
                        <div class="function-item">
                            ...
                            <div class="function-content">
                                <div class="function-title">Uratibu wa Utimilifu wa Maamuzi ya Serikali</div>
                                <p class="function-description">
                        ...
                        <div class="function-item">
                            ...
                            <div class="function-content">
                                <div class="function-title">Uchambuzi na Utafsiri wa Takwimu</div>
                                <p class="function-description">
                        ...
                        <div class="function-item">
                            ...
                            <div class="function-content">
                                <div class="function-title">Uandaji wa Mipango ya Utafiti</div>
                                <p class="function-description">
                        ...
                        <div class="function-item">
                            ...
                            <div class="function-content">
                                <div class="function-title">Uongozi wa Ubora wa Ukusanyaji Takwimu</div>
                                <p class="function-description">
                        ...
                        <div class="function-item">
                            ...
                            <div class="function-content">
                                <div class="function-title">Uratibu wa Utafsiri Takwimu</div>
                                <p class="function-description">
                        ...
                        <div class="function-item">
                            ...
                            <div class="function-content">
                                <div class="function-title">Uratibu wa Usambazaji wa Takwimu</div>
                                <p class="function-description">
                        ...
                        <div class="function-item">
                            ...
                            <div class="function-content">
                                <div class="function-title">Uchambuzi na Uandaji wa Taarifa za Usambazaji</div>
                                <p class="function-description">
                        ...
                        <div class="function-item">
                            ...
                            <div class="function-content">
                                <div class="function-title">Uwasiliani na Ofisi ya Mtakwimu Mkuu</div>
                                <p class="function-description">
                        ...
                        <div class="function-item">
                            ...
                            <div class="function-content">
                                <div class="function-title">Utoaji wa Takwimu na Utaalamu</div>
                                <p class="function-description">
                        ...
                        <div class="function-item">
                            ...
                            <div class="function-content">
                                <div class="function-title">Shughuli Nyingine Zinazopangiwa</div>
                                <p class="function-description">
                ...
                <div class="important-note">
                    <h3>Umuhimu wa Mipango na Takwimu</h3>
                    <p>
                        Divisheni ya Mipango na Takwimu ina jukumu muhimu katika kuhakikisha ufanisi na uadilifu 
                        wa shughuli za taasisi. Kwa kutoa mipango sahihi, uchambuzi wa kitaalamu wa takwimu, na 
                        usimamizi bora wa bajeti, divisheni hii inachangia kwa kiasi kikubwa katika kufikia malengo 
                        ya taasisi. Mipango bora na takwimu sahihi ni msingi wa maamuzi ya kiuchumi na uongozi bora, 
                        na hivyo divisheni hii inakuwa kiini cha mafanikio ya taasisi kwa ujumla.
                    </p>
                </div>
            </div>
        </div>
