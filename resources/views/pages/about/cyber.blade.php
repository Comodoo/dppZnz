...
<head>
    ...
    <title>Divisheni ya Makosa Yanayovuka Mipaka, Dawa za Kulevya na Uhalifu wa Mtandao - DPP Zanzibar</title>
    <style>
...
<body>
    ...
    <div class="hero-banner">
        ...
        <div class="hero-content">
            <h1 class="hero-title">DIVISHENI YA MAKOSA YANAYOVUKA MIPAKA, DAWA ZA KULEVYA NA UHALIFU WA MTANDAO</h1>
            <p class="hero-subtitle">Upambanaji na Makosa ya Kimataifa, Dawa za Kulevya na Uhalifu wa Kidijitali</p>
        </div>
    </div>
        ...
        <div class="main-card">
            <div class="content-wrapper">
                ...
                <div class="page-header">
                    <h1>Divisheni ya Makosa Yanayovuka Mipaka, Dawa za Kulevya na Uhalifu wa Mtandao</h1>
                    <p class="intro-text">
                        Divisheni hii ina jukumu la kupokea na kuyafanyia kazi majalada ya kesi yanayohusiana na makosa 
                        yanayovuka mipaka na uhalifu wa kimtandao, kuhakikisha usalama wa kimataifa na kudhibiti 
                        uhalifu unaotumia teknolojia ya kisasa.
                    </p>
                </div>
                ...
                <div class="mandate-section">
                    ...
                    <p>
                        Divisheni ya Makosa Yanayovuka Mipaka, Dawa za Kulevya na Uhalifu wa Mtandao ina jukumu muhimu 
                        la kushughulikia aina changamano za uhalifu unaofanya kazi kupitia mipaka ya nchi na kutumia 
                        teknolojia ya kisasa. Divisheni hii inalenga kupambana na mitandao ya kimataifa ya uhalifu 
                        na kuhakikisha usalama wa nchi katika ulimwengu wa kidijitali.
                    </p>
                    <p>
                        Lengo kuu la divisheni hii ni kuzuia na kudhibiti makosa ya kimataifa, kupambana na biashara 
                        haramu ya dawa za kulevya, na kulinda wananchi dhidi ya uhalifu wa mtandaoni kupitia usimamizi 
                        wa kisheria na ushirikiano wa kimataifa.
                    </p>
                </div>
                    ...
                    <div class="focus-areas-container">
                        ...
                        <div class="focus-area-card">
                            <div class="focus-area-header">
                                ...
                                <div class="focus-area-title">Makosa Yanayovuka Mipaka</div>
                            </div>
                            <div class="focus-area-content">
                                <p class="focus-area-description">
                                    Uhalifu unaofanya kazi kupitia mipaka ya nchi na kuhusisha mitandao ya kimataifa.
                                </p>
                                <div class="crime-examples">
                                    <h4>Mifano ya Makosa:</h4>
                                    <ul>
                                        <li>Biashara haramu ya kimataifa</li>
                                        <li>Uhalifu wa kisheria kati ya nchi</li>
                                        <li>Ufadhili wa ugaidi na shughuli za kigaidi</li>
                                        <li>Uhalifu wa kisiasa unaovuka mipaka</li>
                                        <li>Utakasaji wa fedha haramu kimataifa</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="focus-area-card">
                            <div class="focus-area-header">
                                <div class="focus-area-icon">💊</div>
                                <div class="focus-area-title">Dawa za Kulevya</div>
                            </div>
                            <div class="focus-area-content">
                                <p class="focus-area-description">
                                ...
                                <div class="crime-examples">
                                    <h4>Mifano ya Makosa:</h4>
                                    <ul>
                                        <li>Uuzaji na usafirishaji wa dawa za kulevya</li>
                                        <li>Uzalishaji na kutengeneza dawa za kulevya</li>
                                        <li>Mitandao ya usambazaji wa dawa za kulevya</li>
                                        <li>Uhalifu unaohusiana na madawa ya kulevwa</li>
                                        <li>Uchafuzi wa fedha kutokana na biashara ya dawa za kulevya</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="focus-area-card">
                            <div class="focus-area-header">
                                <div class="focus-area-icon">💻</div>
                                <div class="focus-area-title">Uhalifu wa Mtandao</div>
                            </div>
                            <div class="focus-area-content">
                                <p class="focus-area-description">
                                ...
                                <div class="crime-examples">
                                    <h4>Mifano ya Makosa:</h4>
                                    <ul>
                                        <li>Udanganyifu wa mtandaoni na ukwepaji wa kodi</li>
                                        <li>Uvamizi wa mifumo ya kompyuta</li>
                                        <li>Uhalifu wa kifedha mtandaoni</li>
                                        <li>Ujangili wa taarifa na uvunjaji wa faragha</li>
                                        <li>Uenezi wa maudhui haramu mtandaoni</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="functions-list">
                        ...
                        <div class="function-item">
                            ...
                            <div class="function-content">
                                <div class="function-title">Upokeaji na Uchakataji wa Majalada</div>
                        ...
                        <div class="function-item">
                            ...
                            <div class="function-content">
                                <div class="function-title">Ushauri wa Kiupelelezi</div>
                                <p class="function-description">
                        ...
                        <div class="function-item">
                            ...
                            <div class="function-content">
                                <div class="function-title">Usimamiji wa Mashtaka</div>
                                <p class="function-description">
                        ...
                        <div class="function-item">
                            ...
                            <div class="function-content">
                                <div class="function-title">Uandaji na Utoaji wa Ripoti</div>
                                <p class="function-description">
                        ...
                        <div class="function-item">
                            ...
                            <div class="function-content">
                                <div class="function-title">Ushauri na Mapendekezo kwa Idara</div>
                                <p class="function-description">
                ...
                <div class="important-note">
                    ...
                    <p>
                        Divisheni ya Makosa Yanayovuka Mipaka, Dawa za Kulevya na Uhalifu wa Mtandao ina jukumu muhimu 
                        katika kudumisha usalama wa kimataifa wa Zanzibar na Tanzania kwa ujumla. Kwa kushughulikia 
                        makosa haya changamano, divisheni hii inalinda usalama wa taifa, inazuia uhalifu wa kimataifa, 
                        na kuhakikisha kwamba Zanzibar inabaki salama katika ulimwengu wa kidijitali. Divisheni hii 
                        inafanya kazi kwa ushirikiano wa karibu na mashirika ya kimataifa, taasisi za usalama wa 
                        nchi, na wadau wa teknolojia ili kushughulikia kwa ufanisi asili changamano ya makosa haya 
                        ya kisasa.
                    </p>
                </div>
            </div>
